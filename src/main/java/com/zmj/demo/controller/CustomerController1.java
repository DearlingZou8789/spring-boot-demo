...
import com.zmj.demo.service.CustomerService1;
...
public class CustomerController1 {
    ...
    private final static Logger logger = LoggerFactory.getLogger(CustomerController1.class);
    ...
    */
    ...
    public Result<Customer> cutomerAdd(@Valid Customer cus_a, BindingResult bindingResult) {
        ...
        return ResultUtil.success(customerService.insertCustomer(cus));
    }
    ...
    public Result<List<Customer>> getHandGender(@PathVariable("gender") String gender) {
        try {
            List<Customer> customers = customerService.findCustomersByGender(gender);
